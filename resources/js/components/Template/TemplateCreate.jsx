...
// DOM element
if (document.getElementById('template-create-component')) {
    // find element by id
    const element = document.getElementById('template-create-component');

    // create new props object with element's data-attributes
    const props = Object.assign({}, element.dataset);

    // render element with props (using spread)
    ReactDOM.render(<TemplateCreate {...props} />, element);
}