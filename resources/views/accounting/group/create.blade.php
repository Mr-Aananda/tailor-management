    ...
    <div class="container">
        ...
        <div class="print-none">
            <ul class="mt-2 nav nav-tabs">
                ...
                <li class="nav-item">
                    <a class="nav-link active" href="{{ route('group.create') }}">New Entry</a>
                </li>
        ...
        <div class="card border-0">
            <div class="card-header p-0 border-0 d-flex mb-3">
                <!-- page title -->
                <div class="mt-3">
                    <h4 class="main-title">Create new group</h4>
                    <p><small>Primary setup for <strong>Template</strong> and <strong>Journal</strong>.</small></p>
                </div>
            ...
            <div class="card-body p-0 pt-3">
                <form action="{{ route('group.store') }}" method="POST">
                    ...
                    <div class="mb-3 row">
                        <div class="col-2">
                            <label for="group-name" class="mt-1 form-label required">Group name</label>
                        </div>

                        <div class="col-6">
                            <input type="text" name="name" value="{{ old('name') }}" class="form-control" id="group-name" placeholder="Characters only" required>
