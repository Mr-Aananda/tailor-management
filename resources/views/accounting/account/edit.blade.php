    ...
    <div class="container">
        ...
        <div class="card border-0">
            <div class="card-header p-0 border-0 d-flex mb-3">
                <!-- page title -->
                <div class="mt-3">
                    <h4 class="main-title">Change account details</h4>
            ...
            <div class="card-body p-0 pt-3">
                <form action="{{ route('accounts.update', $record->id) }}" method="POST">
                    @csrf
                    @method('PATCH')
                    ...
                    <div class="mb-3 row">
                        ...
                        <div class="col-6">
                            <input type="text" name="name" value="{{ old('name', $record->name) }}" class="form-control" id="account-name" placeholder="Characters only">
                    ...
                    <div class="mb-3 row">
                        ...
                        <div class="col-4">
                            <select name="element_id" class="form-control" id="account-element">
                                <option value="" selected disabled>---</option>
                                @foreach($elements as $element)
                                    <option value="{{ $element->id }}" {{ (old('element_id', $record->element_id) == $element->id) ? 'selected' : '' }}>
                                        {{ $element->name }}
                                    </option>
                                @endforeach
                            </select>
