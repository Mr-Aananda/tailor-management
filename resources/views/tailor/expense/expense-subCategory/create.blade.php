        ...
        <div class="border-0 card">
            <div class="p-0 mb-3 border-0 card-header d-flex">
                ...
                <div class="mt-3">
                    ...
                    <p><small>Can create <strong>Subcategory</strong> from here for expenses.</small></p>
                </div>
            ...
            <div class="p-0 pt-3 card-body">
                <form action="{{ route('expense-subcategory.store') }}" method="POST">
                    ...
                    <div class="mb-3 row">
                        <div class="col-2">
                            <label for="subcategory-name" class="mt-1 form-label required"> Subcategory name </label>

                        </div>

                        <div class="col-4">
                            <input type="text" name="subcategory_name" value="" class="form-control" id="subcategory-name" placeholder="Characters only">
