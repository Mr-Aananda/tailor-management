        ...
        <div class="border-0 card">
            <div class="p-0 mb-3 border-0 card-header d-flex">
                ...
                <div class="mt-3">
                    ...
                    <p><small>Can create <strong>category</strong> from here for expenses.</small></p>
                </div>
            ...
            <div class="p-0 pt-3 card-body">
                <form action="{{ route('expense-category.store') }}" method="POST">
                    ...
                    <div class="mb-3 row">
                        ...
                        <div class="col-4">
                            <input type="text" name="category_name" value="" class="form-control" id="category-name" placeholder="Characters only">
