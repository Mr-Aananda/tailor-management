<x-app-layout>
    <x-slot name="title">Expense category trash</x-slot>

    <div class="container">
        <!-- container menu -->
        @include('coaching.expense.expense-category.menu')
        <!-- container menu end -->
                        ...
                        <form action="{{ route('expense-category.trash') }}" method="GET">
                            ...
                            <div class="row gy-1 gx-3">
                                <div class="col-12 col-sm-6 col-lg-3">
                                    <label for="expense-category-name" class="form-label">Expense category</label>
