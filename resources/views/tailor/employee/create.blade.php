            ...
            <div class="p-0 pt-3 card-body">
                <form action="{{ route('employee.store') }}" method="POST">
                    ...
                    <div class="mb-3 row">
                        ...
                        <div class="col-4">
                            <input type="text" name="employee_name" value="{{ old('employee_name')}}" class="form-control" id="employee-name" placeholder="Characters only" required>
                        ...
                        <div class="col-3">
                            <select name="employee_role" class="form-control" id="employee-role" required>
                                ...
                                @foreach ($employees_role as $role)
                                    <option value="{{ $role }}" {{ (old('employee_role') == $role) ? 'selected' : '' }}>
                                        {{ $role }}
                                    </option>
                                @endforeach
                            </select>
                    ...
                    <div class="mb-3 row">
                        ...
                        <div class="col-3">
                            <input type="number" name="basic_salary" value="{{ old('basic_salary')}}" class="form-control" id="basic-salary" placeholder="0.00" required>
                    ...
                    <div class="mb-3 row">
                        ...
                        <div class="col-3">
                            <input type="number" name="nid_number" value="{{ old('nid_number')}}" class="form-control" id="nid-number" placeholder="Number only">
