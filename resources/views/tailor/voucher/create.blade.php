    ...
    <div class="container">
        ...
        <div class="border-0 card">
            <div class="p-0 mb-3 border-0 card-header d-flex">
                <!-- page title -->
                <div class="mt-3">
                    <h4 class="main-title">Create new voucher</h4>
                    <p><small>Can create <strong>voucher</strong> from here.</small></p>
                </div>
            ...
            <div class="p-0 pt-3 card-body">
                <form action="{{ route('voucher.store') }}" method="POST">
                    ...
                    <div class="mb-3 row">
                        ...
                        <div class="col-3">
                            <input type="text" name="voucher_number" value="{{ $random_voucher_number }}" class="form-control" id="voucher_number" readonly>
                    ...
                    <div class="mb-3 row">
                        ...
                        <div class="col-4">
                            <div class="input-group">
                                ...
                                <div class="col-6">
                                    <div class="input-group">
                                        <input type="number" name="discount" value="{{ old('discount') }}" class="form-control" placeholder="0.00" id="discount" aria-describedby="button-addon-paid" required>
                                    </div>
