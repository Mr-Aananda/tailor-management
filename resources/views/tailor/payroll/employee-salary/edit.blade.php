<x-app-layout>
    <x-slot name="title">Employee salary Edit </x-slot>
    ...
    <div class="container">
        ...
        <div class="border-0 card">
            <div class="p-0 mb-3 border-0 card-header d-flex">
                <!-- page title -->
                <div class="mt-3">
                    <h4 class="main-title">Edit old employee salary</h4>
                    <p><small>Can edit an employee salary here.</small></p>
                </div>
