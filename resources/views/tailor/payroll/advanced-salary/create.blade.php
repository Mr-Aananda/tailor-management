    ...
    <div class="container">
        ...
        <div class="border-0 card">
            <div class="p-0 mb-3 border-0 card-header d-flex">
                <!-- page title -->
                <div class="mt-3">
                    <h4 class="main-title">Create new advanced salary</h4>
            ...
            <div class="p-0 pt-3 card-body">
                <form action="{{ route('advanced-salary.store') }}" method="POST">
                    @csrf
                    {{-- Salary date start --}}
                     <div class="mb-3 row">
                        <div class="col-2">
                    ...
                    <div class="mb-3 row">
                     ...
                     {{-- <div class="mb-3 row">
                        <div class="col-2">
                            <label for="installment" class="mt-1 form-label">Monthly installment</label>
                        </div>

                        <div class="col-3">
                            <input type="number" name="installment" value="{{ old('installment')}}" class="form-control" id="installment" placeholder="0.00">
