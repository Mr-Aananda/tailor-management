            ...
            <div class="p-0 pt-3 card-body">
                <form action="{{ route('cash.store') }}" method="POST">
                    ...
                    <div class="mb-3 row">
                        ...
                        <div class="col-4">
                            <input type="text" name="cash_name" value="{{ old('cash_name')}}" class="form-control" id="cash-name" placeholder="Characters only" required>
                    ...
                    <div class="mb-3 row">
                        ...
                        <div class="col-4">
                            <input type="number" name="balance" value="{{ old('balance')}}" class="form-control" id="balance" placeholder="0.00" required>
